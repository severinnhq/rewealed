            ...
            <div className="relative flex-1 flex flex-col h-full p-4 bg-white rounded-lg overflow-hidden">
              ...
              <div className="flex-shrink-0 py-6">
                <div className="flex justify-center space-x-6">
                  <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 transition-colors">
                  ...
                  <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 transition-colors">
